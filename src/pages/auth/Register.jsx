...
import { FiArrowRight, FiMail, FiLock, FiUser, FiCheck } from "react-icons/fi";
...
export default function Register() {
  ...
  return (
    <div className="min-h-screen grid md:grid-cols-2 bg-brand-bg">
      {/* Brand panel */}
      <div className="hidden md:flex relative bg-brand-surface border-r border-brand-border overflow-hidden flex-col justify-between p-10">
      ...
      <div className="flex items-center justify-center px-6 py-16">
        ...
        >
          ...
          <h1 className="font-display text-2xl font-semibold text-ink mt-2 mb-1">Create your account</h1>
          <p className="text-sm text-muted mb-7">Get your first match reading in seconds</p>
              ...
              >
                {role === r && (
                  <motion.span
                    ...
                    className="absolute inset-0 bg-brand-bg rounded-md shadow-sm border border-brand-border -z-10"
          ...
          {password.length > 0 && (
            <motion.div
              ...
              className="flex gap-3 -mt-2 mb-4"
            >
          ...
          />
          {!matchOk && (
            <p className="font-mono text-[10px] uppercase tracking-wider text-match-bad -mt-3 mb-4">
          ...
          <AnimatePresence>
            {error && (
              <motion.p
                ...
                animate={{ opacity: 1, y: 0 }}
                exit={{ opacity: 0 }}
                className="text-sm text-match-bad mb-4"
              >
                {error}
              </motion.p>
            )}
